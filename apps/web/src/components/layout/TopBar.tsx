        ...
        <div className="flex items-center gap-3">
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <div className="hidden leading-tight sm:block">
              <div className="text-sm font-extrabold tracking-tight text-slate-900">GramBiz AI</div>
              <div className="text-[10px] font-medium text-slate-500">{tr('subtitle', lang)}</div>
            </div>
